...
HD_PWD='C:/Users/puach/Documents/Y2S2/EE2026/poker_uart/poker_uart.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log poker_uart.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source poker_uart.tcl
