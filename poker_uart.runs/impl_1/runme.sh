...
HD_PWD='C:/Users/puach/Documents/Y2S2/EE2026/poker_uart/poker_uart.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log poker_uart.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source poker_uart.tcl -notrace
